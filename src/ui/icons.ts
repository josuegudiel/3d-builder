...
export const ICONS: Record<string, string> = {
  ...
  angle: wrap('<path d="M4 19h16"/><path d="M4 19L17 5.5"/><path d="M12.6 19a8.6 8.6 0 00-2.5-6.1"/>'),
  solids: wrap('<rect x="3.5" y="8.5" width="10" height="10" rx="0.6"/><rect x="10.5" y="5.5" width="10" height="10" rx="0.6"/>'),
