...
HERRAJES = [
    (4, 'Anclaje helicoidal 30", 3000 lb, con varilla 1/2" y tensor',
     'NO OPCIONAL. Dentro de la huella, bajo el tablero'),
    (32, 'PERNO DE CARRO 1/2" x 5 3/4" HDG con tuerca ciega y arandela',
     'JABALCONES, 2 por extremo. Con tornillos NO pasa (826 lb)'),
    (8, 'PERNO DE CARRO 1/2" x 5 3/4" HDG con tuerca ciega y arandela',
     'Largueros de la plataforma a los 4 postes, 2 por poste'),
    (4, 'Base de poste galvanizada para 4x4, al patín', 'con tirafondos 1/4" x 3"'),
    (4, 'Capitel (post cap) galvanizado para 4x4', 'la carrera armada mide 3 1/2" justos'),
    (16, 'Herraje antihuracán (hurricane tie)',
     '14 en obra: 2 por cercha interior, 4 por hastial'),
    (600, 'Tornillo ESTRUCTURAL de madera #9 x 1 5/8" con informe ICC-ES',
     'CARTELAS. PROHIBIDO el tornillo de pladur'),
    (1, 'Caja de tornillos estructurales de 3" (5 lb)', 'estructura y colas de alero'),
    ...
    (1, 'Rollo de banda de arranque (starter strip)',
     'alero y sobre cada quiebro de rodilla'),
    (1, 'Yarda cúbica de grava #57',
